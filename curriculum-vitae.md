...
職務内容：  
 ・社内データ活用の初期検証  
- センサーデータを使った不良検知モデルの作成とデータ収集の提案及びPJ推進  
       - 製品の画像検査と異常検知 (検査工程自動化)   
       - その他分析依頼への要望対応 (協力会社の技術力評価,部品寿命分析,BIツール作成)  
・データ活用に備えた社内システムの整備  
　　　 - AI開発知見の属人化解決のためのナレッジベース導入企画  
...
職務内容：  
・新製品の開発検証業務(分散分析・新機能提案と実験機でのデータ収集と検証)  
・実験計画を用いた部品形状と製品性能の関係性評価(温度湿度風速センサー、時系列データ)  
・顧客データを使用した試験的な異常検知  
...
学部：生命科学科  
修士：理工学研究科  
研究：認知症治療薬に向けた誘導体の合成研究  
研究成果：候補化合物・新規誘導体の合成(2016/06、学会発表)
